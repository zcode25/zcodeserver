    ...
    <div class="container">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-xl-8 text-center">
                ...
                <p class="mb-5 text-dark fs-5">ZCODE provides dynamic web development solutions by delivering digital experiences that seamlessly combine innovation, functionality, and aesthetics.</p>
                <a href="#contact" class="btn btn-primary btn-lg px-4 me-2">Consult with Us</a>
                <a href="/project" class="btn btn-light btn-lg">See Projects</a>
            </div>
        </div>
    </div>
  </section>
